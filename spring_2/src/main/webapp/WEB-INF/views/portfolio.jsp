...
<link href="css/style.css?ver=20180821-5" rel="stylesheet">
...
<body>
  ...
  ============================-->
   ...
   <script>
   function OverFun() {
      document.getElementById("profilecontents1").style.fontSize = "2.7vh"
         document.getElementById("profilecontents2").style.fontSize = "2.7vh"
      document.getElementById("portfolioForm").style.background="rgba(0,0,0,0.5)";
      document.getElementById("name").style.fontSize = "2.1vh"
         document.getElementById("school").style.fontSize = "2.1vh"
         document.getElementById("specification").style.fontSize= "2.1vh"
   ...
   function PortfolioOn() {
      ...
      document.getElementById("Chung").innerHTML="이화섭 (ChungMa)";
         document.getElementById("Doo").style.fontSize = "1.7vh";
         document.getElementById("Gae").style.fontSize = "1.7vh";
         document.getElementById("Chung").style.fontSize = "1.7vh";
   ...
   <section id="hero">
      <table id = "portfolioForm" border="0">
      <tbody>
         <tr id="divSpec">
