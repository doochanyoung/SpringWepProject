...
public class BoardCommentController {
	...
	public ResponseEntity<String> update(@PathVariable("boardCommentId") int boardCommentId, @RequestBody BoardCommentVO vo){
		ResponseEntity<String> entity = null;
		try {
	...
	public ResponseEntity<Map<String, Object>> listPage(@PathVariable("boardId") int boardId, @PathVariable("page") int page){
