...
private static final Logger logger = LoggerFactory.getLogger(HomeController.class);
	...
	@ResponseBody
	@RequestMapping("/getAttach/{boardId}")
	public List<String> getAttach(@PathVariable("boardId") int boardId) throws Exception{
		logger.info("/getAttach/" + boardId);
		return service.getAttach(boardId);
	}
